...
ActiveRecord::Schema.define(version: 20160501123218) do
  ...
  add_index "shouts", ["content_id", "content_type"], name: "index_shouts_on_content_id_and_content_type", using: :btree
